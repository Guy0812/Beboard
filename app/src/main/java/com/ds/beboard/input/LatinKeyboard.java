...
public class LatinKeyboard extends Keyboard {
     ...
     * visible while {@link InputMethodManager# s h o uldOff erSwitching ToNextInputMethod(IBinder)}
    ...
    private Key mEmojiSwitchKey;

    private Key mSaveEmojiSwitchKey;
    ...
    protected Key createKeyFromXml(Resources res, Row parent, int x, int y, XmlResourceParser parser) {
        ...
        }else if (key.codes[0] == LatinKeyboardView.KEYCODE_EMOJI_SWITCH) {
            mEmojiSwitchKey = key;
            mSaveEmojiSwitchKey = new LatinKey(res, parent, x, y, parser);
        }
        return key;
    }
    ...
    void setImeOptions(Resources res, int options) {
        ...
        switch (options&(EditorInfo.IME_MASK_ACTION|EditorInfo.IME_FLAG_NO_ENTER_ACTION)) {
            ...
            case EditorInfo.IME_ACTION_SEND:
                ...
                break;
            default:
                mEnterKey.icon = res.getDrawable(R.drawable.ic_keyboard_return_black_24dp);
                mEnterKey.label = null;
                break;
        }
    }
